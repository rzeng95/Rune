...
module.exports = function(app, passport) {
        ...
        User.findOne({'local.userid': req.params.userid}, function(err, usr){
            ...
            Project.find({
                ...
                if (usr.local.githubUrl && usr.local.github) {
                    var options = {
                        url: 'https://api.github.com/users/' + usr.local.github + '/repos?type=all&sort=updated&client_id=fb79527a871e5ba8f0f7&client_secret=a82aa7f700c3f1022aefa81abdf77cf590593098',
                        headers: {
                            'User-Agent': 'request'
                        }
                    };
    ...
    // User profile delete POST request.
    app.post('/u/:userid/edit/delete', Helper.isLoggedIn, Helper.doesUserExist, function(req, res) {
        async.waterfall([
